...
from deep_miml.cifar_bags import get_train_val_split_data, get_test_data, MIMLBagsData, collate_fn
...
if __name__ == '__main__':
	...
	parser.add_argument('--num_bags_val', type=int, default=100, metavar='NVal',
	...
	parser.add_argument('--save_file_to', type=str, default='../data/miml_data2000.pt',
							help='location to save the file')

	parser.add_argument('--cpu_workers', type=int, default=4, metavar='S',
		                    help='Number of workers')

	parser.add_argument('--seed', type=int, default=1)

	parser.add_argument('--m', type=int, default=4, help='Upper bound on number of instances per category per bag')
	...
	train_dat, val_dat = get_train_val_split_data(root=args.root, transform=transform,num_workers=args.cpu_workers)

	# test raw data
	test_dat = get_test_data(root=args.root, transform=transform,num_workers=args.cpu_workers)
	...
	image_datasets['test'] = MIMLBagsData(test_dat, # tuple
