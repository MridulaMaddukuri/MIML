...
# parser.add_argument('--model_name', type=str, required=True, help='options: resnet18, resnext50 and alexnet')
...
parser.add_argument('--data_file_path', type=str, default = 'data/miml_test_data_5000.pt',  help='data/miml_test_data_5000.pt')
...
for m_n in ['resnet18', 'resnet34', 'resnet50']:
    for m_t in ['avg', 'attention']:
        file_path = Path.cwd().joinpath(args.save_folder,"cifar10_{}_{}_pretrained_{}.pt".format(m_n, m_t, args.use_pretrained))
...
# # results_file = Path.cwd().joinpath(args.save_folder, 'results_{}_{}_pretrained_{}.json'.format(args.model_name, args.model_type, args.use_pretrained))
